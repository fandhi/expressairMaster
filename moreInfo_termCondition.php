			...
			<div id="content_page">	
				...
				<div id="left_wrap">
					...
					<div class="sideleft_mid">
						...
						<div class="sideleftmenu">
							<ul class="">
								<li><a class="active" href="moreInfo_termCondition.php"><span>Terms and Conditions</span></a></li>
				...
				<div id="right_wrap">
					...
					<div id="artikel">
						...
						<br />
						<?php include('inc_termCondition.php');?>
...
include("mobile/moreInfo_termCondition.php");
