...
<div id="content_page">
                ...
                <ul class="">
                    ...
                    <li><a class="active" href="moreInfo_faq1.php"><span>FAQ</span></a>
                        <ul class="child">
                            ...
                            <li><a class="active" href="moreInfo_faq3.php"><span>Baggage</span></a></li>
    ...
    <div id="artikel" class="faq">
        <div class="padd_1">
            <h1>FAQ - Baggage</h1>
            <p>
                <span style="color:#333;">Baggage Claim Areas</span><br />
                Order and priority for unloading is determined by cabin class flown and loading position. Please allow 10-50 minutes for your baggage to be delivered to the claim area. <br />
            ...
            <p>
                <span style="color:#333;">Delayed Baggage</span> <br />
            ...
            <p>
                <span style="color:#333;">Baggage Damage</span> <br />
            ...
            <ul class="sub">
                <li>Minor damage of protruding parts such as wheels, feet, straps, locks, extending handles, hanger hooks, 		  	  loose flaps, pockets or any kind of attached item.</li>
                <li>Minor dents or scratches or torn baggage.</li>
                <li>Internal damage and damage caused by contents.</li>
                <li>Damage to oversized/over-packed bags.</li>
                <li>Cardboard boxes and other packing containers not suitable for carriage.</li>
                <li>Baggage with Limited Release Tags.</li>
                <li>Baggage with inadequate packing.</li>
            </ul>
            <br />
            <br />
            <p>
                For domestic routes, if your baggage is damaged or any contents are missing as a result of damage or theft, you should report this immediately after arrival at the airport’s Baggage Service department.  After leaving the baggage claim area, Garuda Indonesia can no longer take responsibility or accept a report for processing. <br />
                For international routes, if you discover major damage to your baggage, please report this to Garuda Indonesia as soon as you arrive. You can also send a written notice to Customer Care within 7 days after arrival. <br />
                Send an e-mail to Customer Care
            </p>
            <p>
                <span style="color:#333;">Baggage Compensation</span>
            </p>
            <p>
                <span style="color:#333">LOSS</span><br />
                For international travel, according to the Warsaw Convention, liability for loss of checked baggage is limited to USD$20.00 per kilogram (2.2lb) unless a higher value has been declared in advance and excess value charges have been paid. <br />
            ...
            <p>
                <span style="color:#333">DAMAGE</span><br />
                Garuda Indonesia and its agents have exercised due diligent care in all baggage handling. Nevertheless, damage might occur under certain circumstances. Luggage repair is available at major airports. These services provide door-to-door delivery of repaired or replacement luggage. Garuda Indonesia will be responsible for appropriate repair or replacement costs. <br />
                If your baggage is beyond repair, the age of possessions may be taken into account. Garuda Indonesia will compensate based on market value and depreciation of the damaged luggage. <br />
                For domestic routes, according to Peraturan Menteri Perhubungan Nomor PM. 77 tahun 2011; Garuda Indonesia can no longer accept a report for processing if checked luggage has been removed from the baggage claim area. <br />
                For international travel, according to the Warsaw Convention, liability for damage of checked baggage is limited to USD$20.00 per kilogram (2.2lb) unless a higher value has been declared in advance and excess value charges have been paid. <br />
            </p>
            <p>
                <span style="color:#333">CABIN BAGGAGE</span><br />
            ...
            <p>
                Unclaimed Baggage <br />
                <span style="color:#333">CHECKED BAGGAGE </span> <br />
                As a passenger; you are entitled to pick up your own baggage at the airport baggage claim area. This designated baggage claim area could be at a stop-over airport or the terminating airport. <br />
                If your baggage is not picked up, Garuda Indonesia will store it for 5 days; after that, it will be sent to Central Baggage Tracing & Prevention in Jakarta for 90 days. If a passenger fails to claim their baggage within 90 days, its disposal is subject to Garuda Indonesia’s discretion. <br />
                Please click here for more information about unclaimed baggage at airports that serve Garuda Indonesia. <br />
            </p>
            <p>						
                <span style="color:#333">-UNCLAIMED PROPERTY</span> <br />
            ...
            <p>						
                <span style="color:#333">Baggage Tracing</span> <br />
                This link is designed to give you another convenient option for obtaining current information regarding the status of your mishandled baggage. All you need to do is enter the file reference number provided by our baggage service staff and your name. Then, click the "submit" button and the system will tell you the status of your lost baggage. <br />
